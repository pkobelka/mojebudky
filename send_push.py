...
Použití:
    ...
    python send_push.py "Nové hnízdění!" "Budka č. 42 hlásí sýkoru koňadru 🐦"
...
def main():
    if len(sys.argv) < 3:
        print('Použití: python send_push.py "Titulek" "Text zprávy"')
        sys.exit(1)
    ...
    for key, token in tokens:
        ...
        try:
            ...
            # Token vypršel nebo byl odvolán – smaž ho
